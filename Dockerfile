...
COPY --from=frontend-build /app/src/maykinmedia/static /app/src/maykinmedia/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=maykinmedia.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://github.com/maykinmedia/maykinmedia" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="maykinmedia"
