...
handler500 = "maykinmedia.utils.views.server_error"

admin.site.enable_nav_sidebar = False
admin.site.site_header = "maykinmedia admin"
admin.site.site_title = "maykinmedia admin"
admin.site.index_title = "maykinmedia dashboard"
