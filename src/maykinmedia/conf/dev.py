...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-4pe9lb$zcxmc_o2rsgn+ft(7^=5-o0q=*bvw)15-6fc%el$en(",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "maykinmedia")
os.environ.setdefault("DB_USER", "maykinmedia")
os.environ.setdefault("DB_PASSWORD", "maykinmedia")
