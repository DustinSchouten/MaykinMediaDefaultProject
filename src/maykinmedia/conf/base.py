...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "maykinmedia"),
        "USER": config("DB_USER", "maykinmedia"),
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "maykinmedia.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "maykinmedia.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "maykinmedia_sessionid"
...
CSRF_FAILURE_VIEW = "maykinmedia.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "maykinmedia.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "maykinmedia"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"maykinmedia {ENVIRONMENT}",
